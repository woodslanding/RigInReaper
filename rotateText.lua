...
function RotateText(Ptext, Pdegrees, PdestX, PdestY)
  --local LW, LH, Ldim, DEGREES_TO_RADIANS
  
      DEGREES_TO_RADIANS = 0.017453
      SaveRed = gfx.r; SaveGreen = gfx.g; SaveBlue = gfx.b
  ...
  --    LW = math.max(LW, 19)
      ...
      gfx.a = 0.90
      gfx.r = SaveRed; gfx.g = SaveGreen; gfx.b = SaveBlue -- set the text colour
      ...
      gfx.blit(127, 1, Pdegrees * DEGREES_TO_RADIANS,  -- source, scale, rotation (in radians) [, 
...
--[[
function Rotate_text(Ptext, Pdegrees, PdestX, PdestY,LW,LH)

    DegToRad = 1 / 360 * 2 * 3.14159
    local SaveRed, SaveGreen,SaveBlue = gfx.r, gfx.g, gfx.b
    ...
    gfx.r = SaveRed
    gfx.g = SaveGreen
    gfx.b = SaveBlue -- set the text colour
