return {
    vstName = "Reaktor5", name = "reaktor", emptyPreset = "",
    ...
    params = {},
    banks = {
        prism = { name = "prism", hue = 278, midiin = 1, trim = 86, sat = 73, lokey = 1, hikey = 127, 
            params = {ENC8 = 5,SWB2 = 21,DRB5 = 18,ENC1 = 10,SWB3 = 11,ENC3 = 10,ENC6 = 4,SWA5 = 10,ENC2 = 10,ENC7 = 17,SWA4 = 21,SWB1 = 10,SWA6 = 21,SWA3 = 21,ENC4 = 9,ENC5 = 18},
            presets = {"ghost flute", "Hudi-gurdi", "More Quacking", "whisper cycle"}
        },
        favorites = { name = "favorites", sat = 74, hue = 0, lokey = 1, hikey = 127, 
            params = {},
